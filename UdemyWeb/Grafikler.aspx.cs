...
public partial class Grafikler : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        while (dr2.Read())
        {
            Chart3.Series["Cinsiyetler"].Points.AddXY(Convert.ToString(dr2[0]), int.Parse(dr2[1].ToString()));
        }
        ...
        while (dr4.Read())
        {
            Chart4.Series["Ogrenci"].Points.AddXY(Convert.ToString(dr4[0]), int.Parse(dr4[1].ToString()));
        }
